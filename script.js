...
$(function() {
    ...
    $('form').on('submit', function(event){
        ...
        const printToPage = function(family) {
            ...
            let image = $('<img>').attr('src', "assets/dragon.svg");
            let text = $('<p>').text(family.text).addClass(family.color);
            let reTry = `<div class="tryAgain button animated infinite pulse"><p><a href="">Don't like what you see? Try again!</a></p></div>`;

            // $('.your-results').addClass('page').append(image);

            $('.results-wrapper').append(header, text, reTry);
